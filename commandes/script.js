...
const fetchGitHubRepoDetails = async () => {
  try {
    const _0x1c6838 = await axios.get("https://api.github.com/repos/Caseyweb/NHEZHO-MD");
    const {
      name: _0x4ae93b,
...
const commands = ["git", "sc", "mchuga", "frezra", "ezrafre", "last", "liverpool", "anfield", "script", 'cs'];
